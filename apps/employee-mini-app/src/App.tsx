    ...
    case 'outside-telegram':
      return (
        <Standalone title="Откройте кнопкой в чате">
          ...
          {quick && (
            // Выход, а не тупик. Кнопка нижней клавиатуры по документации
            // Telegram подписи не приносит, и если это окно открылось
            // именно так, человеку нужен путь вперёд, а не объяснение.
            <p className="state-text">
              Если вы нажали её и попали сюда — отправьте боту команду{' '}
              <b>/scan</b>. Он пришлёт кнопку, которая открывает сканер
              наверняка.
            </p>
          )}
