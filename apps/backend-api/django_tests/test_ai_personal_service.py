...
@pytest.fixture()
def service() -> SqlPersonalDataQueryService:
...
def test_container_wires_real_personal_data_service():
    from humotech.ai_assistant.container import build_personal_data_service

    service = build_personal_data_service()
    assert isinstance(service, SqlPersonalDataQueryService)
    assert service.is_available() is True


def test_container_survives_disabled_module():
