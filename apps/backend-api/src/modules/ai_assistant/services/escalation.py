...
from src.modules.ai_assistant.services.safety import sanitize_for_log
        ...
        *,
        ...
        existing = self.session.scalar(
            select(UnansweredQuestion).where(
                UnansweredQuestion.organization_id == scope.organization_id,
                UnansweredQuestion.normalized_hash == normalized_hash,
                UnansweredQuestion.language == language,
                UnansweredQuestion.office_id == scope.office_id,
                UnansweredQuestion.region_id == scope.region_id,
            )
        )
