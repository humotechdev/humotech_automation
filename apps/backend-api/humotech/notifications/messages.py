...
# Бумага по просьбе человека: он нажал «прислать» в кабинете. Вебвью
# Telegram не даёт сохранить файл, поэтому бумага приходит сюда — тут
# её и пересылают, и печатают, и она остаётся в переписке.
APPLICATION_COPY = "Заявление по вашей заявке."
CERTIFICATE_COPY = "Справка, приложенная к вашей заявке."
