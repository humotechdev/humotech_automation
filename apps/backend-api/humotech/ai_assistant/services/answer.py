...
from humotech.ai_assistant.prompts import PromptBundle, get_prompt
...
from humotech.ai_assistant.services.cache import CacheKeyParts, CacheService
...
from humotech.ai_assistant.services.safety import check_question, sanitize_for_log
...
class AnswerService:
    ...
    def answer(self, request: AnswerRequest) -> AnswerResponse:
        ...
        scope = resolve_employee_scope(employee_id=request.employee_id)
        if scope is None:
        ...
        revision = current_revision(scope.organization_id)
