    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'regions',
                'indexes': [models.Index(fields=['organization'], name='ix_regions_organization_id')],
                'constraints': [models.UniqueConstraint(fields=('organization', 'code'), name='uq_regions_org_code'), models.CheckConstraint(condition=models.Q(('status__in', ['ACTIVE', 'INACTIVE', 'ARCHIVED'])), name='ck_regions_status')],
            },
        ),
    ]
