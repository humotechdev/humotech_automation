...
Все эти экраны открыты ДО завершения ознакомления — иначе пройти его
было бы нечем. Отсюда `onboarding_gate = False` на каждом: гейт закрывает
рабочие функции, а не дорогу к их открытию.
...
class OnboardingSelfView(EmployeeSelfView):
    """Общее основание: те же два входа, но без гейта."""
